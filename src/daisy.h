...
typedef struct Misc
{
   ...
   char cd_dev[MAX_STR], pulseaudio_device[5], tts[12][MAX_STR];
   ...
   char orig_input_file[MAX_STR + 1], search_str[30];
...
extern void open_xml_file (misc_t *, my_attribute_t *, char *, char *);
